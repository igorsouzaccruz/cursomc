...
public class CursomcApplication implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		Cliente cli1 = new Cliente(null,"maria silva","maria@gmail.com","12312312303", TipoCliente.PESSOAFISICA);
		cli1.getTelefones().addAll(Arrays.asList("999999999","8888888888"));
		
		Endereco e1 = new Endereco(null,"Rua flores","300","Apto 203","Jardim","382208232",cli1,c1);
		Endereco e2 = new Endereco(null,"Avenida matos","105","Sala 800","Centro","31231231",cli1,c2);
		...
		pagamentoRepository.saveAll(Arrays.asList(pagton1,pagton2));
	}
}
